// This file is included only to show the original ii code from which plom-ii
// derives; whereas plom-ii.c is covered by the GPLv3, this old code is
// covered by the MIT license defined in the file LICENSE.old.

/* (C)opyright MMV-MMVI Anselm R. Garbe <garbeam at gmail dot com>
 * (C)opyright MMV-MMXI Nico Golde <nico at ngolde dot de>
 * See LICENSE.old file for license details. */
#include <errno.h>
#include <netdb.h>
#include <sys/types.h>
